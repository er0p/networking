...
3. Построить схему пространства IP-адресов компании "ABC". Провайдром выделена сеть 10.13.0.0/20. Компания состоит из 5 филиалов, центрального офиса (ЦО) и центра обработки данных (ЦОД). Выполняются следующие условия:

...
## Задания
1. Написать сценарий, эмулирующий командную строку Cisco IOS в рамках конфигурирования сетевых параметров устройства. Реализовать следующие команды:
  ...
  * interface {ethernet | loopback} *number* - выбо интерфейса для конфигурирования
